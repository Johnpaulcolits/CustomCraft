            ...
            <tr id="category-<?php echo $row['category_id']; ?>">
                ...
                <td>
                    <button class="button" onclick="deleteProduct(<?php echo $row['category_id']; ?>, '<?php echo $row['category_image']; ?>')">
                        <img src="https://img.icons8.com/?size=100&id=67884&format=png&color=FA5252" class="delete-image" style="width: 30px">
                    </button>
                </td>
                <!-- Button to trigger modal -->
                <td>
  <button class="button" data-bs-toggle="modal" data-bs-target="#addCategoryModal" data-category-id="<?php echo $row['category_id']; ?>">
    <img src="https://img.icons8.com/?size=100&id=11684&format=png&color=228BE6" style="width: 30px">
  </button>
</td>
            </tr>   
        <?php } ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addCategoryModal.addEventListener('show.bs.modal', function (event) {
        ...
        // Extract info from data-category-id attribute
        var categoryId = button.getAttribute('data-category-id');
        // Update the modal's content.
        var modalCategoryIdInput = addCategoryModal.querySelector('#modalCategoryId');
...
<div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="custom-form" action="category.php" method="POST" enctype="multipart/form-data">
...
if (isset($_POST['updatecategory'])) {
    ...
    $fetch_query = "SELECT category_image FROM categories WHERE category_id = ?";
    ...
    $category_image = $existing_image; // Default to the existing image
    if (!empty($_FILES['category_image']['name'])) {
        ...
        if (!in_array(strtolower($file_ext), $allowed_types)) {
            echo "<script>alert('Invalid image format! Only JPG, JPEG, PNG & GIF allowed.'); window.location.href='category.php?id=$category_id';</script>";
            exit();
        }
        ...
        if (move_uploaded_file($_FILES["category_image"]["tmp_name"], $target_file)) {
            ...
            $category_image = $target_file; // Update with the new image path
        } else {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Error updating category.'); window.location.href='category.php?id=$category_id';</script>";
    }
