...
<!-- 
  ...
  <?php
// Get filter from GET or POST (default: yearly)
$filter = isset($_GET['filter']) ? $_GET['filter'] : 'yearly';

// Get all categories for the dropdown
$cat_result = $conn->query("SELECT DISTINCT product_category FROM products");
$categories = [];
...
// Set SQL GROUP BY and date format based on filter
switch ($filter) {
    case 'weekly':
        $groupBy = "YEAR(order_date), WEEK(order_date)";
        $dateLabel = "CONCAT(YEAR(order_date), '-W', WEEK(order_date))";
        break;
    case 'monthly':
        $groupBy = "YEAR(order_date), MONTH(order_date)";
        $dateLabel = "DATE_FORMAT(order_date, '%Y-%m')";
        break;
    case 'yearly':
    default:
        $groupBy = "YEAR(order_date)";
        $dateLabel = "YEAR(order_date)";
        break;
}

// Query for top selling products by period and category
$sql = "
SELECT 
    p.product_id,
    p.product_name,
...
" . ($category ? "WHERE p.product_category = ?" : "") . "
GROUP BY p.product_id, $groupBy
...
<div class="col-12 d-flex justify-content-center">
  <div class="card-style mb-30" style="width:100%; max-width:1200px;">
        ...
        <div class="select-style-1">
          <div class="select-position select-sm">
            ...
            <form method="get" class="mb-3 d-flex gap-2">
              <select name="filter" onchange="this.form.submit()" class="light-bg">
              ...
              <select name="category" onchange="this.form.submit()" class="light-bg">
    ...
    <div class="table-responsive">
      <table class="table top-selling-table w-100 mx-auto" style="min-width:900px;">
        <thead>
          <tr>
            <th></th>
            <th>Products</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="product">
                <div class="image">
                  <img src="../admin/<?php echo $row['product_image']; ?>" alt="" width="40" />
                </div>
            ...
            <td>
              <p class="text-sm"><?php echo $row['total_sold']; ?></p>
            </td>
            <td>
              <p class="text-sm"><?php echo $row['period_label']; ?></p>
            </td>
            <td>
              <!-- <div class="action justify-content-end">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  <li class="dropdown-item"><a href="#0" class="text-gray">Remove</a></li>
                  <li class="dropdown-item"><a href="#0" class="text-gray">Edit</a></li>
                </ul>
              </div> -->
            </td>
          </tr>
...
<style>
/* Make the card and table wider and centered, but still responsive */
.card-style.mb-30 {
  margin-left: auto;
  margin-right: auto;
}
