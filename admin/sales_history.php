...
// Query for delivered orders by period
$sql = "
SELECT 
    p.product_name,
    p.product_image,
  ...
  <div class="card-style mb-30" style="width:100%; max-width:1200px;">
    ...
    <div class="table-responsive">
      <table class="table top-selling-table w-100 mx-auto" style="min-width:900px;">
        ...
        <tbody>
          <?php while($row = $sales_history->fetch_assoc()) { ?>
          <tr>
            <td>
              <div class="product">
                <div class="image">
            ...
            <td>
              <p class="text-sm">₱<?php echo number_format($row['revenue'], 2); ?></p>
            </td>
            <td>
              <span class="status-btn success-btn"><?php echo htmlspecialchars($row['status']); ?></span>
            </td>
            <td>
