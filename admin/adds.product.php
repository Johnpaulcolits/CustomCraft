  ...
  <body>
    ...
    .custom-form {
      ...
      box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);
         ...
         <form class="custom-form" action="adds.product.php" method="POST" enctype="multipart/form-data">
    ...
    <button type="submit" class="btn btn-primary w-100" name="addproduct">Add Product</button>
  </form>
